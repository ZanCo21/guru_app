// ignore_for_file: unused_import, prefer_interpolation_to_compose_strings, use_build_context_synchronously, avoid_unnecessary_containers, avoid_web_libraries_in_flutter
                      ...
                      child: Card(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                child: Text(snapshot.data['data'][index]['pesan'], style: const TextStyle(
                                  fontSize: 20,
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    ...
                                    setState(() {});
                                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('data berhasil di delete')));
                                    } 
                                    );
                                  },
                                  child: const SizedBox(
